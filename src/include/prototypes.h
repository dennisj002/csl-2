...
byte *Interpret_C_Until_NotIncluding_Token5(Interpreter *interp, byte *end1, byte *end2, byte *end3, byte *end4, byte *end5, byte *delimiters, Boolean newlineBreakFlag);
...
void AddDirectoriesToPreprocessor_IncludeDirectory_List(void);
byte *CheckFilename(Symbol *symbol, byte *fname);
int64 _CSL_Defined(void);
void CSL_Undef(void);
int64 CSL_Defined(void);
void CSL_Include_PreProcessor(void);
/* src/basis/lists.c */
