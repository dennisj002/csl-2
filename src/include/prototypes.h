...
int64 _CSL_DoWhileCombinator(block testBlock, block doBlock);
...
void CSL_Do_ClassField(Word *word);
...
void Emit(byte c);
void Context_DoPrompt(Context *cntx, int control);
void Context_DoPrompt(Context * context, int control);
...
byte *Mmap(int64 size);
void Munmap(byte *chunk, int64 size);
void Munmap_OS_Chunk(byte *data);
...
MemChunk *_Mem_ChunkAllocate(int64 size, uint64 allocType);
byte *Mem_ChunkAllocate(int64 size, uint64 allocType);
byte *OVT_Static_AllocMem(int64 size);
OVT_StaticMemSystem *OVT_Static_MemSystem_New(void);
void OVT_Static_FreeMem(byte *mem);
void Free_OVT_Static_Mem(void);
void OVT_FullRestartCompleteDelete(void);
OVT_Static *OVT_Static_New(void);
...
NamedByteArray *MemorySpace_NBA_OvtNew(byte *name, int64 size, int64 allocType);
...
Word *_Interpreter_DoPrefixWord(Context *cntx, Interpreter *interp, Word *word, Boolean prefixFlag);
...
void _Word_Show_NamespaceStackWords(Word *word, int64 flag);
...
void _OpenVmTil_Delete(OpenVmTil *ovt);
...
void OVT_CheckThrowState(int64 signal, int64 restartCondition);
...
byte _OVT_SimpleFinal_Key_Pause(OpenVmTil *ovt);
...
void LC_Debug(LambdaCalculus *lc, byte *lcFuncName, int64 state, Boolean setupFlag);
...
void LO_Substitute(LambdaCalculus *lc, ListObject *lambdaParameters, ListObject *funcCallValues);
...
void _LC_Apply_Arg(LambdaCalculus *lc, ListObject **pl1, int64 *i);
...
ListObject *LO_CompileDefine(ListObject *l0);
ListObject *LO_CompileDefinec(ListObject *l0);
ListObject *LO_Define(ListObject *l0);
ListObject *LO_Definec(ListObject *l0);
ListObject *LO_Set(ListObject *lfirst);
ListObject *LO_Let(ListObject *lfirst, ListObject *locals);
ListObject *_LO_Cons(ListObject *first, ListObject *second);
ListObject *LO_If(ListObject *lfirst, ListObject *locals);
ListObject *LO_Cond(ListObject *lfirst, ListObject *locals);
ListObject *_LC_List(LambdaCalculus *lc, ListObject *lfirst);
ListObject *LO_List(ListObject *lfirst);
ListObject *LO_Begin(ListObject *lfirst, ListObject *locals);
ListObject *LO_Car(ListObject *lfirst);
ListObject *LO_Cdr(ListObject *lfirst);
ListObject *LO_Eval(ListObject *lfirst);
