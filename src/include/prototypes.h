...
void _Lexer_ParseTerminatingMacro(Lexer *lexer, byte termChar, Boolean includeTermChar);
...
Word *Interpret_PrefixFunction_OrUntil_RParen(Interpreter *interp, Word *prefixFunction);
...
Word *CSL_Parse_LParen_For_OperandWord(Word *word, Boolean otherwiseFlag);
