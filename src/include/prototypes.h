...
void _Munmap(MemChunk *mchunk);
void MMAP_Munmap(byte *ptr, int64 size);
void Munmap(MemChunk *mchunk);
byte *_Mmap(int64 size);
byte *Mmap(int64 size);
byte *MMAP_Mmap(int64 size, int64 allocType);
MemChunk *_MemChunk_Allocate(int64 size, uint64 allocType);
MemChunk *MemChunk_AllocateAdd(int64 size, int64 allocType);
...
void MMAP_Munmap_List(dllist *list);
