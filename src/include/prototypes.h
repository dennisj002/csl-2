...
void _TDSCI_Print_StructField(TypeDefStructCompileInfo *tdsci);
...
void Parse_Do_Identifier(TypeDefStructCompileInfo *tdsci, int64 t_type);
void Parse_ArrayField(TypeDefStructCompileInfo *tdsci);
void Parse_Do_Identifier_Field(TypeDefStructCompileInfo *tdsci, int64 t_type);
void Parse_Identifier_Fields(TypeDefStructCompileInfo *tdsci, int64 t_type);
void Parse_Type_Field(TypeDefStructCompileInfo *tdsci, Namespace *type0);
void Parse_Field(TypeDefStructCompileInfo *tdsci);
void Parse_Structure(TypeDefStructCompileInfo *tdsci);
void Parse_StructOrUnion_Type(TypeDefStructCompileInfo *tdsci);
int64 _CSL_Parse_Typedef_Field(TypeDefStructCompileInfo *tdsci, int64 ptType, Boolean printFlag, byte *codeData);
int64 CSL_Parse_Typedef_Field(TypeDefStructCompileInfo *tdsci, Boolean printFlag, byte *codeData);
int64 CSL_Parse_Type_Field(TypeDefStructCompileInfo *tdsci, Boolean printFlag, byte *codeData);
...
Namespace *_CSL_InNamespace(void);
