...
ListObject *LO_Cond0(ListObject *l0, ListObject *locals);
...
ListObject *LO_Logic_Equals(ListObject *l0, ListObject *locals);
ListObject *LO_Plus(ListObject *l0, ListObject *locals);
ListObject *LO_Minus(ListObject *l0, ListObject *locals);
ListObject *LO_LessThan(ListObject *l0, ListObject *locals);
ListObject *LO_Else(ListObject *l0);
