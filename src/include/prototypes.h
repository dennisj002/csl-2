...
void Word_ClassStructure_PrintData(Context *cntx, Word *word, byte *typedefString);
...
int64 CSL_Parse_A_Typed_Field(Context *cntx, Boolean printFlag, byte *codeData);
...
TDSCI *TDSCI_Start(Context *cntx, Word *word, int64 stateFlags);
