...
void _Munmap(byte *chunk, int64 size);
byte *OVT_Static_Mmap(int64 size);
void OVT_Static_Munmap(byte *chunk, int64 size);
void Munmap_OS_Chunk(byte *data);
void munmap_FreeMem(byte *chunk, int64 size);
...
byte *Interpret_C_Until_NotIncluding_Token4(Interpreter *interp, byte *end1, byte *end2, byte *end3, byte *end4, byte *delimiters, Boolean newlineBreakFlag);
