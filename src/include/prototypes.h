...
ListObject *LO_If(ListObject *lfirst, ListObject *locals, int64 ifFlag, ListObject *l0);
ListObject *LO_Cond(ListObject *lfirst, ListObject *locals, int64 ifFlag, ListObject *l0);
