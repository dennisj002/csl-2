...
#define CfrtTil_Compile_JG( jmpToAddr ) _Compile_Jcc (0, GREATER, jmpToAddr , 0)
#define CfrtTil_Compile_JGE( jmpToAddr ) _Compile_Jcc (_NOT_, TTT_LESS, jmpToAddr , 0)
#define CfrtTil_Compile_JEQ( jmpToAddr ) _Compile_Jcc (0, EQ, jmpToAddr , 0)
#define CfrtTil_Compile_JNE( jmpToAddr ) _Compile_Jcc (_NOT_, EQ, jmpToAddr , 0)
#define CfrtTil_Compile_JNG( jmpToAddr ) _Compile_Jcc (_NOT_, GREATER, jmpToAddr , 0)
#define CfrtTil_Compile_JNB( jmpToAddr ) _Compile_Jcc (_NOT_, TTT_BELOW, jmpToAddr , 0)
#define CfrtTil_Compile_JB( jmpToAddr ) _Compile_Jcc (0, TTT_BELOW, jmpToAddr , 0)
#define CfrtTil_Compile_JNL( jmpToAddr ) _Compile_Jcc (_NOT_, TTT_LESS, jmpToAddr , 0)
#define CfrtTil_Compile_JLE( jmpToAddr ) _Compile_Jcc (_NOT_, GREATER, jmpToAddr , 0)
#define CfrtTil_Compile_JL( jmpToAddr ) _Compile_Jcc (0, TTT_LESS, jmpToAddr , 0)
