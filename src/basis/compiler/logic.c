    ...
    else
    {
        ...
        else
        {
            ...
            if ( DataStack_Pop ( ) )
            {
                ...
                token = Interpret_C_Until_NotIncluding_Token4 ( interp, ( byte* ) "else", ( byte* ) "endif", ( byte* ) ":", 0, ( byte* ) " ", 1 ) ;
            ...
            else
            {
                ...
                Interpret_C_Until_NotIncluding_Token4 ( interp, ( byte* ) ";", ( byte* ) ",", ( byte* ) "endif", ( byte* ) "}", ( byte* ) " ", 1 ) ;
            }
        }
    }
}
